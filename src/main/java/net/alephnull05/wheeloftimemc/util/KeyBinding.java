...
public class KeyBinding {
    ...
    public static final String KEY_WEAVE = "key.wheeloftimemc.weave";
    ...
    public static final KeyMapping WEAVE_KEY = new KeyMapping(KEY_WEAVE, KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_KP_ENTER, KEY_CATEGORY_WHEELOFTIME);
